...
extern void EuroDes(byte key1[], byte key2[], byte DesMode, byte OperatingMode, 
                    byte data[]);
extern int32_t des_encrypt(byte *buffer, int32_t len, byte *deskey);
extern int32_t des_decrypt(byte *buffer, int32_t len, byte *deskey);
extern void des_login_key_get(byte *key1, byte *key2, int32_t len, byte *des16);
